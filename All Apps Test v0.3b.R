...
print("H1.1.1T - Reject the no variation null")
...
#--------------------IPD - Strat Decisions Same Count Analysis (H1.2.4T) -------------
...
#--------------------PW - Strategy Fingerprint Analysis (H1.3.1-2T)-----------------
...
#--------------------IPD - Memory Probability Analysis (H1.3.3T)---------------
