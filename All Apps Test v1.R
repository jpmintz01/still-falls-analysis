...
# ---------------------further research - IPD - Convolutional Strategy inference with statistical likelihood using multiple 5-(or x-)round sliding windows?-------------
...
print(descdist(rps_df_1[rps_df_1$Choice_of_Advisor=="human",]$Freq, discrete = FALSE)) 
print(shapiro.test(rps_df_1[rps_df_1$Choice_of_Advisor=="AI",]$Freq))  #not normal
print(descdist(rps_df_1[rps_df_1$Choice_of_Advisor=="AI",]$Freq, discrete = FALSE)) 
print(shapiro.test(rps_df_1[rps_df_1$Choice_of_Advisor=="none",]$Freq)) #not normal
print(descdist(rps_df_1[rps_df_1$Choice_of_Advisor=="none",]$Freq, discrete = FALSE)) 



p<-plot(fitdist(rps_df_1[rps_df_1$Choice_of_Advisor=="human",]$Freq, "nbinom"))
print(p)
p<-plot(fitdist(rps_df_1[rps_df_1$Choice_of_Advisor=="AI",]$Freq, "nbinom"))
print(p)
p<-plot(fitdist(rps_df_1[rps_df_1$Choice_of_Advisor=="none",]$Freq, "nbinom"))
print(p)
