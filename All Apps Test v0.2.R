...
# pw_cols <- pw_cols[!(pw_cols$id %in% c("gdg26","s4441","7ic14","oez14")),] #strip off those who didn't believe the humans in the game were real (did this later)
...
pw_all_data$id <- d$id
pw_all_data$my.decision <- as.factor(d$Choice)  #need to change to coop/defect?
