...
p<- ggplot(pw_df_1, aes(x=Freq))+
  ...
  stat_function(fun = dnorm,color="blue",args = list(mean = mean(pw_df_1$Freq), sd = sd(pw_df_1$Freq)),linetype = "dashed")+ labs(title="PW-Cooperation Density Distribution", x="Frequency", y = "Density of Choices") +scale_x_discrete(limits=c(0:10))+ theme(plot.title = element_text(size=12))
print(p)
...
print("IMPLICATION: Statistical and non-statistical analyses show participants did not vary their initial propensity by adversary.")
...
p<- ggplot(pw_df_1, aes(x=Freq))+
  ...
  stat_function(fun = dnorm,color="green",args = list(mean = mean(pw_df_1[pw_df_1$Adversary=="Human+AI",]$Freq), sd = sd(pw_df_1[pw_df_1$Adversary=="Human+AI",]$Freq)),linetype = "dashed") + labs(title="PW - Cooperation Distribution (by Adversary)",x="Frequency", y = "Density of Choices", color = "Adversary") +scale_x_discrete(limits=c(0:10))+ theme(plot.title = element_text(size=9))
print(p)
print(paste0("Insert ", p$labels$title," Plot"))
ggsave(paste0(p$labels$title,".jpg"), plot=p, device="jpg")
...
print("RESULT: chisq.test, and fisher.test of the all-round sums comparing HUman and AI show difference at p <. 01")
...
print("RESULT: chisq.test, and fisher.test of the all-round sums comparing HUman and Human+AI show NO difference at p <. 05, despite difference in adversary gameplay")
